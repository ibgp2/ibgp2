...
#define DEFAULT_RIPD_HOSTNAME  "ripd"
#define DEFAULT_RIPD_VTY_PORT  2602
...
public:
     ...
     * @param password The password used to connect to ripd (normal mode).
    ...
    RipConfig (
        const std::string & hostname       = DEFAULT_RIPD_HOSTNAME,
