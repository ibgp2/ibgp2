...
#
# Usage:
#   ./gnuplot5_updates.sh dataset_dir simulation_time
#
# Example:
#   ./gnuplot5_updates.sh article 75
#
# Outputs:
#   $result_dir/updates_{fm,rr,ibgp2}.{gnu,dat,eps}
...
do
    echo "" > "$result_dir"/updates_${mode}.dat
done
